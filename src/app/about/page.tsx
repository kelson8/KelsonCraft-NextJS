        ...
        <div>
            <MainContainer>
                ...
                <div className={containerPageClass}>
                    ...
                    <a className={blueLinkCss} href="https://github.com/kelson8/KelsonCraft-NextJS">https://github.com/kelson8/KelsonCraft-NextJS</a>
        ...
        <div className="relative overflow-x-auto bg-neutral-primary-soft shadow-xs rounded-base border border-default">
            <table className="w-full text-sm text-left rtl:text-right text-body">
                ...
                <tr className="bg-neutral-primary border-b border-default">
                    ...
                    <td className="px-6 py-4">
                        I have mostly messed around with FiveM scripts using lua, it&#39;s not a bad scripting language to get stuff done quickly.
                    </td>
                </tr>
                ...
                <tr className="bg-neutral-primary border-b border-default">
                    ...
                    <td className="px-6 py-4">
                        ...
                        Also, I&#39;m decent at Javascript/Typescript and have pretty much rebuilt my website with Typescript and NextJS.
                    </td>
                </tr>
                ...
                <tr className="bg-neutral-primary border-b border-default">
                    ...
                    <td className="px-6 py-4">
                        I have been learning quite a bit of C++ using SFML for game development and using ImGui to mess around with.
